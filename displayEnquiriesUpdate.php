...
$enquiry_id= mysqli_real_escape_string($conn,$_POST['enquiriesUpdate']);
...
<br>
<div class="heading">
    <h3 style="color: white;">Update Enquiries</h3>
</div>
<div class="container">
    <br>
    <form action="updateEnquiries.php" method="post" class="enquiries">
