...
$billing_id= mysqli_real_escape_string($conn,$_POST['invoiceDelete']);
...
<br>
<div class="heading">
    <h3 style="color: white;">Delete Invoice</h3>
</div>
<div class="container">
    <br>
    <form action="deleteInvoice.php" method="post" class="enquiries">
