...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-6">
            <form action="displayReceiptDelete.php" method="post" class="enquiries">
                <br>
                <input type="number" name="receiptDelete" class="form-control" placeholder="* Search Receipt Number" required>
                <div class="buttons">
