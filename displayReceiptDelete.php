...
$receipt_number= mysqli_real_escape_string($conn,$_POST['receiptDelete']);
...
<br>
<div class="heading">
    <h3 style="color: white;">Delete Receipt</h3>
</div>
<div class="container">
    <br>
    <form action="deleteReceipt.php" method="post" class="enquiries">
