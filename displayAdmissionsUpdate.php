...
$admissionNumber= mysqli_real_escape_string($conn,$_POST['admissionsUpdate']);
...
<br>
<div class="heading">
    <h3 style="color: white;">Update Admissions</h3>
</div>
<div class="container">
    <br>
    <form action="updateAdmissions.php" method="post" class="enquiries">
